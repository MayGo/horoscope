...
export const findDailyHoroscope = async (sign: HoroscopeSignType, date: string) => {
...
export const saveDailyHoroscope = async (sign: HoroscopeSignType, date: string, horoscope: HoroscopeResultSchema) => {
    const key = getDailyHoroscopeKey(sign, date);
